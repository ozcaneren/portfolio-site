...
export function AppFooter() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <footer
        ref={footerRef}
        className="max-w-7xl mx-auto px-4 py-10 mt-5 relative before:absolute before:top-0 before:left-4 before:w-[calc(100%-16px)] before:h-[1px] before:bg-gray-100"
        style={{
