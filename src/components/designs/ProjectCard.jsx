    ...
    <div>
      ...
      >
        <div className="mb-2 flex items-center gap-3">
          ...
          <div
            className='relative inline-block select-none whitespace-nowrap bg-purple-500 rounded-full py-1 px-2 align-baseline font-sans text-xs font-medium capitalize leading-none tracking-wide text-white'
          >
